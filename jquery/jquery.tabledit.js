    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            buttons: {
                ...
                foto:{
                    class:'btn btn-sm btn-default',
                    html: '<span class="glyphicon glyphicon-camera"></span>',
                    action: 'foto'
                }
            },
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        // Create foto button.
                        if (settings.fotoButton) {
                            fotoButton = '<button type="button" class="tabledit-photo-button ' + settings.buttons.foto.class + '" style="float: none;">' + settings.buttons.foto.html + '</button>';
                        }
                        ...
                        var toolbar = '<div class="tabledit-toolbar ' + settings.toolbarClass + '" style="text-align: left;">\n\
                                           <div class="' + settings.groupClass + '" style="float: none;">' + editButton + deleteButton + fotoButton +'</div>\n\
                                           ' + saveButton + '\n\
                                           ' + confirmButton + '\n\
                                           ' + restoreButton + '\n\
                                       </div></div>';
        ...
        if (settings.restoreButton) {
             ...
             * @param {object} event
             */
            $table.on('click', 'button.tabl-restore-button', function(event) {
                if (event.handled !== true) {
                    event.preventDefault();
        ...
        if (settings.fotoButton){
            $table.on('click', 'button.tabledit-photo-button', function(event) {
                settings.onFoto(id);
            });
        }
